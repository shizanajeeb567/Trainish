            ...
            <CardContent>
              {Object.entries(groupedItems)
                ...
                .map(([category, items]) => (
                  <div
                    key={category}
                    className="mb-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border border-purple-100"
                  >
                    <button
                    ...
                    {openGroups[category] && (
                      <div className="px-4 pb-4 pt-1 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        {items.map((item) => (
                          <div
                            key={item.key}
                            className="p-3 border border-purple-100 rounded-lg bg-white/70 shadow-sm"
                          >
